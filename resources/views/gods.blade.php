<x-layout>
    <div class="container mx-auto p-6 bg-blue-50 dark:bg-gray-800 shadow-lg rounded-lg">
        ...
        <form action="{{ url(route('gods.index')) }}" method="GET" class="mb-6">
            ...
            <button type="submit" class="rounded-md px-3 py-1 text-gray-800 bg-blue-200 dark:bg-gray-700 dark:text-gray-100 ring-1 ring-transparent transition hover:bg-blue-300 dark:hover:bg-gray-600 focus:outline-none focus-visible:ring-[#FF2D20]">Filter</button>
        </form>
        ...
        <form action="{{ url(route('gods.index')) }}" method="GET" class="mb-6">
            ...
            <button type="submit" class="rounded-md px-3 py-1 text-gray-800 bg-blue-200 dark:bg-gray-700 dark:text-gray-100 ring-1 ring-transparent transition hover:bg-blue-300 dark:hover:bg-gray-600 focus:outline-none focus-visible:ring-[#FF2D20]">Search</button>
        </form>
