...
<article class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6 mb-6 transition-transform transform hover:scale-105">
    ...
    <a href="gods/{{ $god->id }}" class="rounded-md px-3 py-1 text-gray-800 bg-blue-200 dark:bg-gray-700 dark:text-gray-100 ring-1 ring-transparent transition hover:bg-blue-300 dark:hover:bg-gray-600 focus:outline-none focus-visible:ring-[#FF2D20]">Details</a>
</article>
